...
@Js
def PyJsHoisted_encrypt_(
    e, t, PIE_L, PIE_E, PIE_K, PIE_key_id, PIE_phase, this, arguments, var=var
):
    var = Scope(
        {
            "e": e,
    ...
    var.put(
        ...
        Js(
            {
                "L": var.get("parseInt")(var.get("PIE_L")),
                "E": var.get("parseInt")(var.get("PIE_E")),
                "K": var.get("PIE_K"),
                "key_id": var.get("PIE_key_id"),
                "phase": var.get("parseInt")(var.get("PIE_phase")),
            }
        ),
    )
    ...
    var.put(
        "c_var",
        (
            var.get("a_var").callprop("substr", Js(0.0), var.get("PIE").get("L"))
            + var.get("a_var").callprop(
                "substring", (var.get("a_var").get("length") - var.get("PIE").get("E"))
            )
        ),
    )
    ...
    var.put(
        ...
        var.get("a_var").callprop(
            "substring",
            (var.get("PIE").get("L") + Js(1.0)),
            (var.get("a_var").get("length") - var.get("PIE").get("E")),
        ),
    )
    var.put(
        "d_var",
    ...
    var.put(
        ...
        (
            (
                (
                    var.get("a_var").callprop(
                        "substr", Js(0.0), var.get("PIE").get("L")
                    )
                    + Js("0")
                )
                + var.get("d_var").callprop(
                    "substr",
                    Js(0.0),
                    (var.get("d_var").get("length") - var.get("i_var").get("length")),
                )
            )
            + var.get("a_var").callprop(
                "substring", (var.get("a_var").get("length") - var.get("PIE").get("E"))
    ...
    var.put(
        ...
        var.get("n").callprop(
            "reformat",
            var.get("n").callprop(
                "fixluhn", var.get("l_var"), var.get("PIE").get("L"), var.get("u_var")
            ),
            var.get("e"),
        ),
    )
    ...
    return Js(
        [
            ...
            var.get("p_var"),
            var.get("n").callprop(
                "integrity", var.get("PIE").get("K"), var.get("f_var"), var.get("p_var")
            ),
        ]
    )
...
def PyJs_LONG_6_(var=var):
        ...
        while var.get("t") >= Js(0.0):
            PyJsComma(
                var.put(
                    "n",
                    var.get("parseInt")(
                        var.get("e").callprop("substr", var.get("t"), Js(1.0)), Js(10.0)
                    ),
                    "+",
                ),
                var.put("t", Js(2.0), "-"),
        ...
        while var.get("t") >= Js(0.0):
            ...
            PyJsComma(
                var.put(
                    ...
                    (
                        var.get("r")
                        if (var.get("r") < Js(10.0))
                        else (var.get("r") - Js(9.0))
                    ),
                    "+",
                ),
                var.put("t", Js(2.0), "-"),
    ...
    def PyJs_anonymous_1_(e, t, r, this, arguments, var=var):
                ...
                PyJsComma(
                    var.put(
                        ...
                        (
                            (Js(10.0) - var.get("a"))
                            if (
                                ((var.get("e").get("length") - var.get("t")) % Js(2.0))
                                != Js(0.0)
                            )
                            else (
                                (Js(5.0) - (var.get("a") / Js(2.0)))
                                if ((var.get("a") % Js(2.0)) == Js(0.0))
                                else (((Js(9.0) - var.get("a")) / Js(2.0)) + Js(5.0))
                            )
                        ),
                    ),
                    (
                        (
                            var.get("e").callprop("substr", Js(0.0), var.get("t"))
                            + var.get("a")
                        )
                        + var.get("e").callprop("substr", (var.get("t") + Js(1.0)))
                    ),
                )
                if (Js(0.0) != var.get("a"))
                else var.get("e")
        ...
        return PyJsComma(
            (
                var.put("a", (Js(10.0) - var.get("r")), "+")
                if (var.get("a") < var.get("r"))
                else var.put("a", var.get("r"), "-")
            ),
            PyJs_LONG_2_(),
        )
            ...
            try:
                (
                    (
                        ...
                        .get("base10")
                        .callprop(
                            "indexOf", var.get("e").callprop("charAt", var.get("r"))
                        )
                        >= Js(0.0)
                    )
                    and var.put(
                        "t", var.get("e").callprop("substr", var.get("r"), Js(1.0)), "+"
                    )
                )
            finally:
            ...
            try:
                (
                    PyJsComma(
                        var.put(
                            "r",
                            var.get("e").callprop("substr", var.get("a"), Js(1.0)),
                            "+",
                        ),
                        var.put("a", Js(var.get("a").to_number()) + Js(1)),
                    )
                    if (
                        (var.get("a") < var.get("e").get("length"))
                        and (
                            var.get("n")
                            .get("base10")
                            .callprop(
                                "indexOf", var.get("t").callprop("charAt", var.get("i"))
                            )
                            >= Js(0.0)
                        )
                    )
                    else var.put(
                        "r", var.get("t").callprop("substr", var.get("i"), Js(1.0)), "+"
                    )
                )
            finally:
    ...
    def PyJs_anonymous_5_(e, t, n, this, arguments, var=var):
            ...
            (
                (
                    (
                        (
                            (
                                var.get("String").callprop("fromCharCode", Js(0.0))
                                + var.get("String").callprop(
                                    "fromCharCode", var.get("t").get("length")
                                )
                            )
                            + var.get("t")
                        )
                    ...
                    + var.get("String").callprop(
                        "fromCharCode", var.get("n").get("length")
                    )
                )
                + var.get("n")
            ),
        ...
        return var.get("a").callprop("WordToHex", var.get("s").get("0")) + var.get(
            "a"
        ).callprop("WordToHex", var.get("s").get("1"))
        ...
        PyJsComma(
            PyJsComma(
                PyJsComma(
                    PyJsComma(
                        PyJsComma(
                            var.get("n").put("base10", Js("0123456789")),
                            var.get("n").put(
                                "base62",
                                Js(
                        ...
                        var.get("n").put("luhn", PyJs_anonymous_0_),
                    ),
                    var.get("n").put("fixluhn", PyJs_anonymous_1_),
                ),
                var.get("n").put("distill", PyJs_anonymous_3_),
            ),
            var.get("n").put("reformat", PyJs_anonymous_4_),
        ),
        var.get("n").put("integrity", PyJs_anonymous_5_),
    )
...
def PyJs_anonymous_7_(e, this, arguments, var=var):
    ...
    PyJsComma(
        var.get(u"this").put("toString", PyJs_anonymous_8_),
...
def PyJs_anonymous_9_(e, this, arguments, var=var):
    ...
    PyJsComma(
        var.get(u"this").put("toString", PyJs_anonymous_10_),
        var.get(u"this").put("message", var.get("e")),
    )
...
def PyJs_anonymous_11_(e, this, arguments, var=var):
    ...
    PyJsComma(
        var.get(u"this").put("toString", PyJs_anonymous_12_),
        var.get(u"this").put("message", var.get("e")),
    )
    ...
    Js(
        {
            ...
            "exception": Js(
                {
                    "corrupt": PyJs_anonymous_7_,
                    "invalid": PyJs_anonymous_9_,
                    "bug": PyJs_anonymous_11_,
                }
            ),
        }
    ),
...
def PyJs_anonymous_13_(e, this, arguments, var=var):
    ...
    (
        var.get(u"this").get("_tables").get("0").get("0").get("0")
        or var.get(u"this").callprop("_precompute")
    )
    ...
    var.put("d", Js(1.0))
    if (
        PyJsStrictNeq(Js(4.0), var.get("s")) and PyJsStrictNeq(Js(6.0), var.get("s"))
    ) and PyJsStrictNeq(Js(8.0), var.get("s")):
        PyJsTempException = JsToPyException(
            var.get("r")
            .get("exception")
            .get("invalid")
            .create(Js("invalid aes key size"))
        )
    ...
    PyJsComma(
        var.get(u"this").put(
            ...
            Js(
                [
                    var.put("i", var.get("e").callprop("slice", Js(0.0))),
                    var.put("o", Js([])),
                ]
            ),
        ),
    ...
    while var.get("t") < ((Js(4.0) * var.get("s")) + Js(28.0)):
        try:
                        ...
                        (
                            (
                                (
                                    (
                                        var.get("c").get(
                                            PyJsBshift(var.get("a"), Js(24.0))
                                        )
                                        << Js(24.0)
                                    )
                                    ^ (
                                        var.get("c").get(
                                            ((var.get("a") >> Js(16.0)) & Js(255.0))
                                        )
                                        << Js(16.0)
                                    )
                                )
                                ^ (
                                    var.get("c").get(
                                        ((var.get("a") >> Js(8.0)) & Js(255.0))
                                    )
                                    << Js(8.0)
                                )
                            )
                            ^ var.get("c").get((Js(255.0) & var.get("a")))
                        ),
                    ),
                    (
                        ((var.get("t") % var.get("s")) == Js(0.0))
                        and PyJsComma(
                            var.put(
                                "a",
                                (
            ...
            PyJsComma(
                PyJsComma(
                    var.put("a", var.get("i").get((var.get("t") - Js(1.0)))),
                    (
                        (
                            ((var.get("t") % var.get("s")) == Js(0.0))
                            or (
                                PyJsStrictEq(Js(8.0), var.get("s"))
                                and ((var.get("t") % var.get("s")) == Js(4.0))
                            )
                        )
                        and PyJs_LONG_14_()
                    ),
                ...
                var.get("i").put(
                    var.get("t"),
                    (var.get("i").get((var.get("t") - var.get("s"))) ^ var.get("a")),
                ),
            )
        finally:
        ...
        try:
            ...
            def PyJs_LONG_15_(var=var):
                return var.get("o").put(
                    ...
                    (
                        var.get("a")
                        if ((var.get("t") <= Js(4.0)) or (var.get("n") < Js(4.0)))
                        else (
                            (
                                (
                                    var.get("u")
                            ...
                            ^ var.get("u")
                            .get("3")
                            .get(var.get("c").get((Js(255.0) & var.get("a"))))
                        )
                    ),
                )
...
def PyJs_anonymous_18_(this, arguments, var=var):
    ...
    while var.get("d").get(var.get("t")).neg():
        try:
                        ...
                        PyJsComma(
                            PyJsComma(
                                PyJsComma(
                                    ...
                                    var.get("d").put(var.get("t"), var.get("i")),
                                ),
                                var.get("l").put(var.get("i"), var.get("t")),
                            ),
                            var.put(
                                "c",
                                (
                                    (
                                        (
                                            ...
                                            ^ (Js(65537.0) * var.get("a"))
                                        )
                                        ^ (Js(257.0) * var.get("r"))
                                    )
                                    ^ (Js(16843008.0) * var.get("t"))
                                ),
                            ),
                        ),
                        var.put(
                            "o",
                            (
                                (Js(257.0) * var.get("f").get(var.get("i")))
            ...
            PyJsComma(
                var.put(
                    "t", (Js(1.0) if (Js(0.0) == var.get("r")) else var.get("r")), "^"
                ),
                var.put(
                    "n",
                    (
                        Js(1.0)
                        if (Js(0.0) == var.get("p").get(var.get("n")))
                        else var.get("p").get(var.get("n"))
                    ),
                ),
            )
    # for JS loop
    ...
    while var.get("e") < Js(5.0):
        try:
            PyJsComma(
                var.get("u").put(
                    var.get("e"),
                    var.get("u").get(var.get("e")).callprop("slice", Js(0.0)),
                ),
                var.get("s").put(
                    var.get("e"),
                    var.get("s").get(var.get("e")).callprop("slice", Js(0.0)),
                ),
            )
        finally:
            (var.put("e", Js(var.get("e").to_number()) + Js(1)) - Js(1))
...
def PyJs_anonymous_20_(e, t, this, arguments, var=var):
    ...
    if PyJsStrictNeq(Js(4.0), var.get("e").get("length")):
        PyJsTempException = JsToPyException(
            ...
            .get("exception")
            .get("invalid")
            .create(Js("invalid aes block size"))
        )
        raise PyJsTempException
    ...
    var.put(
        "s",
        (
            var.get("e").get((Js(3.0) if var.get("t") else Js(1.0)))
            ^ var.get("c").get("1")
        ),
    )
    ...
    var.put(
        "l",
        (
            var.get("e").get((Js(1.0) if var.get("t") else Js(3.0)))
            ^ var.get("c").get("3")
        ),
    )
                                ...
                                PyJsComma(
                                    ...
                                    var.put(
                                        ...
                                        (
                                            ...
                                            ^ var.get("c").get((var.get("p") + Js(3.0)))
                                        ),
                                    ),
                                ),
                                var.put("p", Js(4.0), "+"),
    ...
    while var.get("o") < Js(4.0):
        try:
            ...
            def PyJs_LONG_22_(var=var):
                return var.get("m").put(
                    ((Js(3.0) & (-var.get("o"))) if var.get("t") else var.get("o")),
                    (
                        (
                            (
                                (
                                    (
                                        var.get("g").get(
                                            PyJsBshift(var.get("u"), Js(24.0))
                                        )
                                        << Js(24.0)
                                    )
                                    ^ (
                                        var.get("g").get(
                                            ((var.get("s") >> Js(16.0)) & Js(255.0))
                                        )
                                        << Js(16.0)
                                    )
                                )
                                ^ (
                                    var.get("g").get(
                                        ((var.get("d") >> Js(8.0)) & Js(255.0))
                                    )
                                    << Js(8.0)
                                )
                            )
                            ^ var.get("g").get((Js(255.0) & var.get("l")))
                        )
                        ^ var.get("c").get(
            ...
            PyJsComma(
                PyJsComma(
                    PyJsComma(
                        PyJsComma(
                            PyJsComma(PyJs_LONG_22_(), var.put("n", var.get("u"))),
                            var.put("u", var.get("s")),
                        ),
                        var.put("s", var.get("d")),
                    ),
...
PyJsComma(
    var.get("r").get("cipher").put("aes", PyJs_anonymous_13_),
    var.get("r")
    .get("cipher")
    .get("aes")
    .put(
        ...
        Js(
            {
                "encrypt": PyJs_anonymous_16_,
                "decrypt": PyJs_anonymous_17_,
                "_tables": Js(
                    [
                        Js([Js([]), Js([]), Js([]), Js([]), Js([])]),
                        Js([Js([]), Js([]), Js([]), Js([]), Js([])]),
                ...
                "_precompute": PyJs_anonymous_18_,
                "_crypt": PyJs_anonymous_20_,
            }
        ),
    ),
)
...
def PyJs_anonymous_23_(e, this, arguments, var=var):
    ...
    return (
        ...
        .get("cipher")
        .get("aes")
        .create(var.get("a").callprop("HexToWords", var.get("e")))
    )
    ...
    while var.get("n") < Js(4.0):
        try:
            var.get("t").put(
                var.get("n"),
                var.get("parseInt")(
                    var.get("e").callprop("substr", (Js(8.0) * var.get("n")), Js(8.0)),
                    Js(16.0),
                ),
            )
        finally:
    ...
    while var.get("t") > Js(0.0):
        PyJsComma(
            ...
            var.put(
                ...
                .callprop(
                    "substr",
                    (PyJsBshift(var.get("e"), var.get("t")) & Js(15.0)),
                    Js(1.0),
                ),
                "+",
            ),
...
var.put(
    ...
    Js(
        {
            "HexToKey": PyJs_anonymous_23_,
            "HexToWords": PyJs_anonymous_24_,
            "Hex": Js("0123456789abcdef"),
            "WordToHex": PyJs_anonymous_25_,
        }
    ),
)
var.put("i", Js({}))
            ...
            PyJsComma(
                PyJsComma(
                    var.get("e").put(
                        "0",
                        (
                            ((Js(2147483647.0) & var.get("e").get("0")) << Js(1.0))
                            | PyJsBshift(var.get("e").get("1"), Js(31.0))
                        ),
                    ),
                    var.get("e").put(
                        "1",
                        (
                            ((Js(2147483647.0) & var.get("e").get("1")) << Js(1.0))
                            | PyJsBshift(var.get("e").get("2"), Js(31.0))
                        ),
                    ),
                ),
                var.get("e").put(
                    "2",
                    (
                        ((Js(2147483647.0) & var.get("e").get("2")) << Js(1.0))
                        | PyJsBshift(var.get("e").get("3"), Js(31.0))
                    ),
                ),
            ),
            var.get("e").put(
                "3", ((Js(2147483647.0) & var.get("e").get("3")) << Js(1.0))
            ),
        )
...
def PyJs_anonymous_29_(e, t, this, arguments, var=var):
    ...
    PyJsComma(
        var.get("i").callprop("leftShift", var.get("r")),
        (
            var.get("i").callprop("MSBnotZero", var.get("a"))
            and var.get("r").put("3", var.get("i").get("const_Rb"), "^")
        ),
    )
    # for JS loop
    var.put("o", Js(0.0))
    while var.get("o") < var.get("t").get("length"):
        PyJsComma(
            var.get("n").put(
                ((var.get("o") >> Js(2.0)) & Js(3.0)),
                (
                    (Js(255.0) & var.get("t").callprop("charCodeAt", var.get("o")))
                    << (Js(8.0) * (Js(3.0) - (Js(3.0) & var.get("o"))))
                ),
                "^",
            ),
            (
                (
                    ...
                    and (var.get("o") < var.get("t").get("length"))
                )
                and var.put("n", var.get("e").callprop("encrypt", var.get("n")))
            ),
        )

    def PyJs_LONG_30_(var=var):
        return (
            (Js(0.0) != var.get("o")) and (Js(0.0) == (Js(15.0) & var.get("o")))
        ) or PyJsComma(
            PyJsComma(
                PyJsComma(
                    var.put("a", var.get("r").get("0")),
            ...
            var.get("n").put(
                ((var.get("o") >> Js(2.0)) & Js(3.0)),
                (Js(128.0) << (Js(8.0) * (Js(3.0) - (Js(3.0) & var.get("o"))))),
                "^",
            ),
        )
        ...
        PyJsComma(
            PyJsComma(
                PyJsComma(
                    PyJsComma(
                        PyJs_LONG_30_(),
                        var.get("n").put("0", var.get("r").get("0"), "^"),
                    ),
                    var.get("n").put("1", var.get("r").get("1"), "^"),
                ),
                var.get("n").put("2", var.get("r").get("2"), "^"),
            ),
            var.get("n").put("3", var.get("r").get("3"), "^"),
        ),
        var.get("e").callprop("encrypt", var.get("n")),
    )
...
PyJsComma(
    PyJsComma(
        PyJsComma(
            var.get("i").put("MSBnotZero", PyJs_anonymous_26_),
            var.get("i").put("leftShift", PyJs_anonymous_27_),
        ),
        var.get("i").put("const_Rb", Js(135.0)),
    ),
    var.get("i").put("compute", PyJs_anonymous_29_),
)
...
def PyJs_anonymous_31_(e, t, n, r, this, arguments, var=var):
    var = Scope(
        {"e": e, "t": t, "n": n, "r": r, "this": this, "arguments": arguments}, var
    )
            ...
            PyJsComma(
                PyJsComma(
                    PyJsComma(
                        var.get("a").put(
                            "0",
                            (Js(16908544.0) | ((var.get("r") >> Js(16.0)) & Js(255.0))),
                        ),
                        var.get("a").put(
                            "1",
                            (
                                (
                                    (
                                        (
                                            ((var.get("r") >> Js(8.0)) & Js(255.0))
                                            << Js(24.0)
                                        )
                                        | ((Js(255.0) & var.get("r")) << Js(16.0))
                                    )
                                    | Js(2560.0)
                                )
                                | (
                                    ...
                                    & var.get("Math").callprop(
                                        "floor", (var.get("t") / Js(2.0))
                                    )
                                )
                            ),
                        ),
                    ),
                    var.get("a").put("2", var.get("t")),
                ),
                var.get("a").put("3", var.get("i")),
            ),
            var.get("e").callprop("encrypt", var.get("a")),
        )
...
def PyJs_anonymous_33_(e, t, this, arguments, var=var):
    ...
    return PyJsComma(
        (
            (var.get("a") > Js(1.0))
            and var.put("r", Js(var.get("r").to_number()) + Js(1))
        ),
        var.get("r"),
    )
...
def PyJs_anonymous_34_(e, t, n, this, arguments, var=var):
    ...
    while var.get("r") >= Js(0.0):
        try:
            var.put(
                "i", ((var.get("e").get(var.get("r")) * var.get("n")) + var.get("a"))
            )
            PyJsComma(
                var.get("e").put(var.get("r"), (var.get("i") % var.get("t"))),
                var.put(
                    "a",
                    ((var.get("i") - var.get("e").get(var.get("r"))) / var.get("t")),
                ),
            )
        finally:
            var.put("r", Js(var.get("r").to_number()) - Js(1))
...
def PyJs_anonymous_36_(e, t, n, r, a, this, arguments, var=var):
    var = Scope(
        {"e": e, "t": t, "n": n, "r": r, "a": a, "this": this, "arguments": arguments},
        var,
    )
    ...
    while var.get("u") < var.get("t"):
        try:
            PyJsComma(
                var.get("o").callprop(
                    "bnMultiply", var.get("c"), var.get("a"), var.get("n")
                ),
                var.get("o").callprop(
                    "bnAdd", var.get("c"), var.get("a"), var.get("e").get(var.get("u"))
                ),
            )
        finally:
        ...
        while var.get("i") < Js(4.0):
            try:
                var.get("a").put(
                    var.get("i"),
                    (
                        var.get("a").get(var.get("i"))
                        ^ (
                            (
                                (
                                    (
                                        var.get("t").get(
                                            (Js(4.0) * (var.get("o") + var.get("i")))
                                        )
                                        << Js(24.0)
                                    )
                                    | (
                            ...
                            | var.get("t").get(
                                ((Js(4.0) * (var.get("o") + var.get("i"))) + Js(3.0))
                            )
                        )
                    ),
                )
                ...
                var.put("i", Js(var.get("i").to_number()) + Js(1))
        PyJsComma(
            var.put("a", var.get("r").callprop("encrypt", var.get("a"))),
            var.put("o", Js(4.0), "+"),
        )
...
def PyJs_anonymous_38_(e, t, n, r, a, i, c, u, s, this, arguments, var=var):
    ...
    var.put(
        "p",
        var.get("Array").create(
            (((var.get("n").get("length") + var.get("l")) + var.get("s")) + Js(1.0))
        ),
    )
    # for JS loop
    var.put("f", Js(0.0))
    while var.get("f") < var.get("n").get("length"):
        try:
            var.get("p").put(
                var.get("f"), var.get("n").callprop("charCodeAt", var.get("f"))
            )
        finally:
    ...
    while var.get("f") < (var.get("l") + var.get("n").get("length")):
        try:
            ...
            (var.put("f", Js(var.get("f").to_number()) + Js(1)) - Js(1))
    var.get("p").put(
        ((var.get("p").get("length") - var.get("s")) - Js(1.0)), var.get("t")
    )
    # for JS loop
    var.put(
        "m",
    ...
    while var.get("h") < var.get("s"):
        try:
            var.get("p").put(
                ((var.get("p").get("length") - var.get("s")) + var.get("h")),
                var.get("m").get(var.get("h")),
            )
        finally:
    ...
    while var.get("f") < var.get("d"):
        try:
            ...
            def PyJs_LONG_39_(var=var):
                return (
                    (var.get("f") > Js(0.0)) and (Js(0.0) == (Js(3.0) & var.get("f")))
                ) and PyJsComma(
                    PyJsComma(
                        var.put("b", ((var.get("f") >> Js(2.0)) & Js(255.0))),
                        var.put(
                            "b",
                            (
                                ((var.get("b") << Js(8.0)) | (var.get("b") << Js(16.0)))
                                | (var.get("b") << Js(24.0))
                            ),
                            "|",
                        ),
                    ...
                    var.put(
                        ...
                        var.get("e").callprop(
                            ...
                            Js(
                                [
                                    (var.get("v").get("0") ^ var.get("b")),
                                    (var.get("v").get("1") ^ var.get("b")),
                                    (var.get("v").get("2") ^ var.get("b")),
                                    (var.get("v").get("3") ^ var.get("b")),
                                ]
                            ),
                        ),
                    ),
            ...
            PyJsComma(
                PyJsComma(
                    ...
                    var.get("E").put(
                        (Js(2.0) * var.get("f")),
                        PyJsBshift(
                            var.get("y").get((Js(3.0) & var.get("f"))), Js(16.0)
                        ),
                    ),
                ),
                var.get("E").put(
                    ((Js(2.0) * var.get("f")) + Js(1.0)),
                    (Js(65535.0) & var.get("y").get((Js(3.0) & var.get("f")))),
                ),
            )
        finally:
            var.put("f", Js(var.get("f").to_number()) + Js(1))
    return var.get("o").callprop(
        "convertRadix",
        var.get("E"),
        (Js(2.0) * var.get("d")),
        Js(65536.0),
...
def PyJs_anonymous_40_(e, t, n, this, arguments, var=var):
    ...
    if Js(256.0) == var.get("n"):
        ...
        while var.get("a") < var.get("t"):
            try:
                var.get("r").put(
                    var.get("a"), var.get("e").callprop("charCodeAt", var.get("a"))
                )
            finally:
    ...
    while var.get("i") < var.get("t"):
        try:
            var.put(
                "o",
                var.get("parseInt")(
                    var.get("e").callprop("charAt", var.get("i")), var.get("n")
                ),
            )
    ...
    if Js(256.0) == var.get("t"):
        ...
        while var.get("n") < var.get("e").get("length"):
            try:
                var.put(
                    "r",
                    var.get("String").callprop(
                        "fromCharCode", var.get("e").get(var.get("n"))
                    ),
                    "+",
                )
            finally:
        ...
        while var.get("n") < var.get("e").get("length"):
            try:
                var.put(
                    "r",
                    var.get("o").get("alphabet").get(var.get("e").get(var.get("n"))),
                    "+",
                )
            finally:
                (var.put("n", Js(var.get("n").to_number()) + Js(1)) - Js(1))
...
def PyJs_anonymous_42_(e, t, n, r, this, arguments, var=var):
    ...
    var.put(
        "c",
        var.get("o").callprop(
            "precompF", var.get("n"), var.get("a"), var.get("t"), var.get("r")
        ),
    )
    var.put("u", var.get("o").callprop("precompb", var.get("r"), var.get("a")))
    var.put(
        "s",
        var.get("o").callprop("DigitToVal", var.get("e"), var.get("i"), var.get("r")),
    )
    var.put(
        "d",
        var.get("o").callprop(
            "DigitToVal",
            var.get("e").callprop("substr", var.get("i")),
            (var.get("a") - var.get("i")),
            var.get("r"),
        ),
    )
        ...
        try:
            var.put(
                ...
                var.get("o").callprop(
                    ...
                    var.get("t"),
                    var.get("d"),
                    var.get("d").get("length"),
                    var.get("s").get("length"),
                    var.get("c"),
                    var.get("r"),
                    var.get("u"),
                ),
            ...
            while var.get("m") >= Js(0.0):
                try:
                    (
                        PyJsComma(
                            var.get("s").put(var.get("m"), var.get("h")),
                            var.put("f", Js(0.0)),
                        )
                        if (
                            var.put(
                                ...
                                (
                                    (
                                        var.get("s").get(var.get("m"))
                                        + var.get("p").get(var.get("m"))
                                    )
                                    + var.get("f")
                                ),
                            )
            ...
            while var.get("m") >= Js(0.0):
                try:
                    ...
                    (
                        PyJsComma(
                            var.get("d").put(var.get("m"), var.get("h")),
                            var.put("f", Js(0.0)),
                        )
                        if (
                            var.put(
    ...
    return var.get("o").callprop("ValToDigit", var.get("s"), var.get("r")) + var.get(
        "o"
    ).callprop("ValToDigit", var.get("d"), var.get("r"))
...
def PyJs_anonymous_43_(e, t, n, r, this, arguments, var=var):
    ...
    return (
        Js("")
        if (var.get(u"null") == var.get("i"))
        else var.get("o").callprop(
            "encryptWithCipher", var.get("e"), var.get("t"), var.get("i"), var.get("r")
        )
    )
    ...
    Js(
        {
            ...
            "precompF": PyJs_anonymous_31_,
            "precompb": PyJs_anonymous_33_,
            "bnMultiply": PyJs_anonymous_34_,
            "bnAdd": PyJs_anonymous_35_,
            "convertRadix": PyJs_anonymous_36_,
            "cbcmacq": PyJs_anonymous_37_,
            "F": PyJs_anonymous_38_,
            "DigitToVal": PyJs_anonymous_40_,
            "ValToDigit": PyJs_anonymous_41_,
            "encryptWithCipher": PyJs_anonymous_42_,
            "encrypt": PyJs_anonymous_43_,
        }
    ),
)
pass
