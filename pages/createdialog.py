...
class CreateDialog(QtWidgets.QDialog):
    ...
    def setupUi(self, CreateDialog):
        ...
        self.site_box.setStyleSheet(
            "outline: 0;border: 1px solid {};border-width: 0 0 2px;color: rgb(234, 239, 239);".format(
        ...
        self.addtask_btn.setStyleSheet(
            "border-radius: 10px;background-color: {};color: #FFFFFF;".format(
                globalStyles["primary"]
            )
        )
        ...
        self.taskcount_spinbox.setStyleSheet(
            "border: 1px solid {};border-width: 0 0 2px;color: #FFFFFF;".format(
                globalStyles["primary"]
            )
        )
