...
class PollBrowserDialog(QtWidgets.QDialog):
    ...
    def setupUi(self, PbdObj):
        ...
        self.background.setStyleSheet(
            "* {background-color: {}} QPushButton { background-color: %s;color: #FFFFFF;}"
            % (globalStyles["primary"]).format(globalStyles["backgroundDark"])
        )
        font = QtGui.QFont()
        ...
        self.label.setText(
            "Solve any Captchas in the New Browser Window\nClick Below When Finished"
        )
        self.label.setStyleSheet(
            "color: rgb(234, 239, 239); text-align: center; qproperty-alignment: 'AlignCenter'"
        )
        ...
        self.confirmButton.setStyleSheet(
            "color: rgb(234, 239, 239); background-color: {}".format(
